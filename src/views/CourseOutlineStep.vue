<template>
  <div>
    ...
    <button class="btn btn-secondary  d-flex align-items-center mx-auto mt-4 px-4 py-2 shadow-sm" type="button" style="font-weight: 500; font-size: 1.1rem; gap: 0.5rem;" @click="addSection">
